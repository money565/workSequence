...
<template>
  <div>
      ...
      <div class="table-toolbar-right flex-center">
        ...
        <el-tooltip effect="dark" content="列设置" placement="top">
          <el-dropdown :hide-on-click="false" size="small" trigger="click">
            ...
            <template #dropdown>
              <el-dropdown-menu>
                <el-dropdown-item v-for="(c, i) in columns" :key="i">
    ...
    <el-table
      class="mgb20" :style="{ width: '100%' }" border :data="tableData" :row-key="rowKey"
      table-layout="auto" @selection-change="handleSelectionChange"
    >
      <template v-for="item in columns" :key="item.prop">
        <el-table-column
          v-if="item.visible" :prop="item.prop" :label="item.label" :width="item.width"
    ...
    <el-pagination
      v-if="hasPagination" :current-page="currentPage" :page-size="pageSize" :background="true"
