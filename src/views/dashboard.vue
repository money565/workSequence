    ...
    <el-row :gutter="20" class="mgb20">
      <el-col :span="18">
        <el-card shadow="hover">
          ...
          <VChart class="chart" :option="dashOpt1" />
        </el-card>
      </el-col>
      <el-col :span="6">
        <el-card shadow="hover">
          ...
          <VChart class="chart" :option="dashOpt2" />
        </el-card>
      </el-col>
    </el-row>
    <el-row :gutter="20">
      ...
      <el-col :span="10">
        <el-card shadow="hover" :body-style="{ height: '400px' }">
          ...
          <VChart class="map-chart" :option="mapOptions" />
        </el-card>
      </el-col>
      <el-col :span="7">
        <el-card shadow="hover" :body-style="{ height: '400px' }">
          ...
          <div>
            <div v-for="(rank, index) in ranks" :key="index" class="rank-item">
