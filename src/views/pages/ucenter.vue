    ...
    <div class="user-container">
      <el-card class="user-profile" shadow="hover" :body-style="{ padding: '0px' }">
        ...
        <div class="user-avatar-wrap">
          <el-avatar class="user-avatar" :size="120" :src="user.userInfo.userid" />
        </div>
        <div class="user-info">
          <div class="info-name">
          ...
          <div class="info-icon">
            <a href="https://github.com/lin-xin" target="_blank"> <i class="el-icon-lx-github-fill" /></a>
            <i class="el-icon-lx-qq-fill" />
            <i class="el-icon-lx-facebook-fill" />
            <i class="el-icon-lx-twitter-fill" />
          </div>
        </div>
          ...
          <el-tab-pane name="label3" label="修改密码" class="user-tabpane">
            <el-form class="w500" label-position="top">
              ...
              <el-form-item label="确认新密码：">
                <el-input v-model="form.new1" type="password" />
              </el-form-item>
              <el-form-item>
